...
import { Activity, ArrowUpRight, Briefcase, MessageSquare, Star, TrendingUp, Users } from 'lucide-react';
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={project.id} className="flex items-center justify-between p-4 rounded-lg border bg-muted/30 hover:bg-muted/50 transition-colors group">
                  ...
                  <Badge
                    variant={project.status === 'Completed' ? 'outline' : project.status === 'In Progress' ? 'secondary' : 'default'}
                    className={
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={contact.id} className="flex items-center justify-between p-4 rounded-lg border bg-muted/30 hover:bg-muted/50 transition-colors group">
                  ...
                  <Badge
                    variant={contact.status === 'Contacted' ? 'secondary' : 'default'}
                    className={contact.status === 'Contacted' ? 'bg-purple-100 text-purple-800 hover:bg-purple-100 dark:bg-purple-900/20 dark:text-purple-400' : ''}
                  >
                    {contact.status}
                  </Badge>
                </div>
