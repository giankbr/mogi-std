...
export function Hero({ className }: { className?: string }) {
  ...
  return (
    <section className={cn('relative', className)} aria-labelledby="hero-title">
      <div className="mx-auto max-w-6xl px-4 pt-4 pb-5 md:pb-6">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 p-6 md:p-10 flex flex-col justify-between">
              <div className="flex items-center justify-between text-sm text-white/80">
                <p className="hidden md:block">{t('hero.tagline')}</p>
              ...
              <div>
                ...
                <p className="mt-3 md:mt-4 max-w-2xl text-pretty text-sm sm:text-base text-white/85 leading-relaxed">{t('hero.description')}</p>
              ...
              <p className="self-end text-xs text-white/70">{t('hero.scrollDown')}</p>
            </div>
          </div>
        </div>
      </div>
